...
if ($runMigration) {
    ...
    $siteTranslationDefaults = [
        ...
        ['topbar_text',              'en', 'Industrial and hydraulic hose solutions'],
        ['topbar_text',              'de', 'Industrielle und hydraulische Schlauchlösungen'],
        ['topbar_text',              'it', 'Soluzioni per tubi industriali e idraulici'],
        ['topbar_text',              'fr', 'Solutions de tuyaux industriels et hydrauliques'],
        ['meta_description',         'en', 'Flexion Industrial is a trusted provider of industrial and hydraulic hose solutions, supported by strong production partners in Lamone, Switzerland.'],
        ['meta_description',         'de', 'Flexion Industrial ist ein verlässlicher Anbieter für industrielle und hydraulische Schlauchlösungen mit starker Lieferinfrastruktur in Lamone, Schweiz.'],
        ['meta_description',         'it', 'Flexion Industrial offre soluzioni affidabili per tubi industriali e idraulici, con una solida infrastruttura di fornitura a Lamone, Svizzera.'],
        ['meta_description',         'fr', 'Flexion Industrial propose des solutions fiables de tuyaux industriels et hydrauliques avec une infrastructure solide basée à Lamone, Suisse.'],
        // ─ Site arama ─────────────────────────────────────────────────────
        ...
        ['search_placeholder_long',  'en', 'Search hoses or categories...'],
        ['search_placeholder_long',  'de', 'Schlaeuche oder Kategorien suchen...'],
        ['search_placeholder_long',  'it', 'Cerca tubi o categorie...'],
        ['search_placeholder_long',  'fr', 'Rechercher des tuyaux ou categories...'],
        ['search_results_title',     'en', 'Search Results'],
        ['search_results_title',     'de', 'Suchergebnisse'],
        ['search_results_title',     'it', 'Risultati di ricerca'],
        ['search_results_title',     'fr', 'Resultats de recherche'],
        ['search_query_label',       'en', 'Query'],
        ['search_query_label',       'de', 'Suchbegriff'],
        ['search_query_label',       'it', 'Ricerca'],
        ['search_query_label',       'fr', 'Recherche'],
        ['search_empty_prompt',      'en', 'Type a keyword in the search box.'],
        ['search_empty_prompt',      'de', 'Geben Sie ein Stichwort in das Suchfeld ein.'],
        ['search_empty_prompt',      'it', 'Digita una parola chiave nella casella di ricerca.'],
        ['search_empty_prompt',      'fr', 'Saisissez un mot-cle dans le champ de recherche.'],
        ['search_no_results',        'en', 'no results found.'],
        ['search_no_results',        'de', 'keine Ergebnisse gefunden.'],
        ['search_no_results',        'it', 'nessun risultato trovato.'],
        ['search_no_results',        'fr', 'aucun resultat trouve.'],
        ['search_categories_heading','en', 'Categories'],
        ['search_categories_heading','de', 'Kategorien'],
        ['search_categories_heading','it', 'Categorie'],
        ['search_categories_heading','fr', 'Categories'],
        ['search_products_heading',  'en', 'Products'],
        ['search_products_heading',  'de', 'Produkte'],
        ['search_products_heading',  'it', 'Prodotti'],
        ['search_products_heading',  'fr', 'Produits'],
        ['search_submit',            'en', 'Search'],
        ['search_submit',            'de', 'Suchen'],
        ['search_submit',            'it', 'Cerca'],
        ['search_submit',            'fr', 'Rechercher'],
        ['search_products_found',    'en', '{count} products found'],
        ['search_products_found',    'de', '{count} Produkte gefunden'],
        ['search_products_found',    'it', '{count} prodotti trovati'],
        ['search_products_found',    'fr', '{count} produits trouves'],
        ['search_page_title',        'en', 'Search Products'],
        ['search_page_title',        'de', 'Produkte suchen'],
        ['search_page_title',        'it', 'Cerca prodotti'],
        ['search_page_title',        'fr', 'Rechercher des produits'],
        ['search_suggest_aria',      'en', 'Search suggestions'],
        ['search_suggest_aria',      'de', 'Suchvorschlaege'],
        ['search_suggest_aria',      'it', 'Suggerimenti di ricerca'],
        ['search_suggest_aria',      'fr', 'Suggestions de recherche'],
        ['search_results_sentence',  'en', 'Search "{q}" {count} results have been found.'],
        ['search_results_sentence',  'de', 'Suche "{q}" – {count} Ergebnisse gefunden.'],
        ['search_results_sentence',  'it', 'Ricerca "{q}" – {count} risultati trovati.'],
        ['search_results_sentence',  'fr', 'Recherche "{q}" – {count} résultats trouvés.'],
        ['search_order_by',          'en', 'Order by'],
        ['search_order_by',          'de', 'Sortieren nach'],
        ['search_order_by',          'it', 'Ordina per'],
        ['search_order_by',          'fr', 'Trier par'],
        ['search_sort_relevance',    'en', 'Relevance'],
        ['search_sort_relevance',    'de', 'Relevanz'],
        ['search_sort_relevance',    'it', 'Rilevanza'],
        ['search_sort_relevance',    'fr', 'Pertinence'],
        ['search_sort_name_asc',     'en', 'Name A–Z'],
        ['search_sort_name_asc',     'de', 'Name A–Z'],
        ['search_sort_name_asc',     'it', 'Nome A–Z'],
        ['search_sort_name_asc',     'fr', 'Nom A–Z'],
        ['search_sort_name_desc',    'en', 'Name Z–A'],
        ['search_sort_name_desc',    'de', 'Name Z–A'],
        ['search_sort_name_desc',    'it', 'Nome Z–A'],
        ['search_sort_name_desc',    'fr', 'Nom Z–A'],
