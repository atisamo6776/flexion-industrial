...
$requiredTables = [
    ...
    'catalog_product_icons'      => 'Merkezi ikon kütüphanesi',
    'catalog_regulation_images'  => 'Merkezi regülasyon görsel kütüphanesi',
    'product_icon_picks'         => 'Ürün başına seçili ikonlar',
    'product_regulation_picks'   => 'Ürün başına seçili regülasyon görselleri',
...
$requiredColumns = [
    ...
    ['table' => 'product_regulations','column' => 'is_active',           'desc' => 'Regülasyon aktif/pasif (eski)'],
    ['table' => 'product_documents',  'column' => 'is_active',           'desc' => 'Doküman aktif/pasif'],
    ['table' => 'products',           'column' => 'regulation_description','desc' => 'Regülasyon açıklaması (tek dil HTML)'],
